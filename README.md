This project was developed as part of the Interpretation and Compilation of Languages course. This programming language allows you to perform arithmetic operations, print results and variables and store values in memory and access them by references.
